...
namespace BooksRating.Controllers
{
    public class ReadersController : Controller
    {
        ...
        public ReadersController(BookratingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Readers != null ? 
                          ...
                          Problem("Entity set 'BookratingContext.Readers'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email")] Reader reader)
        {
            var readers = _context.Readers.ToArray();
            foreach (var b in readers)
            {
                if (b.Name == reader.Name)
